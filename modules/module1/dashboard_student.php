    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-md-block bg-dark p-0" style="min-height: 100vh;">
                <div class="pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#"><i class="fas fa-building"></i> Browse Clubs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#"><i class="fas fa-calendar-alt"></i> Browse Events</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#"><i class="fas fa-star"></i> My Points</a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-10 p-4">
                ...
                <div class="alert alert-success">Your student dashboard is ready.</div>
            </main>
        </div>
    </div>
